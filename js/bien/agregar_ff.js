...
function agregar_ffToCartTable(cells){
	...
	if (pp == 0 || ff1 == 0 || pc == ''){
		...
		newRow.innerHTML = `
		<td>${pp3}<input type="text" name="par_presupuestaria_1_ff[]" id="ins-type-${increment}" hidden value="${pp1}"></td>
		...
		$("#fuente_financiamiento").val($("#fuente_financiamiento_acc").data("default-value"));
	}
}
