...
<!--[if lt IE 9]>
	<script src="<?=base_url()?>Plantilla/admin/assets/crossbrowserjs/html5shiv.js"></script>
	<script src="<?=base_url()?>Plantilla/admin/assets/crossbrowserjs/respond.min.js"></script>
	<script src="<?=base_url()?>Plantilla/admin/assets/crossbrowserjs/excanvas.min.js"></script>
<![endif]-->
