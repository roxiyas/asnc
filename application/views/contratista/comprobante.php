...
<div id="content" class="content">
    <div class="row">
        ...
        <div class="col-lg-12 panel mt-3" id="imp1" >
            <div class="row">
                <div class="col-10 pull-left">
        	           <img src="<?php echo base_url('Plantilla/img/membretesnc.png'); ?>" height="50"  />
                </div>
                <div class="pull-right">
                    <img src="<?php echo base_url('Plantilla/img/logosnc.png'); ?>" height="80"  />
                </div>
            </div>
                <div class="row mt-3">
                    ...
                    <div class="col-12 text-center mt-3">
                        ...
                        <h3><b>EN EL REGISTRO NACIONAL DE CONTRATISTAS</b></h3>
                    </div>
                    <div class="col-12 text-center mt-3">
                        <h4>Este Registro Nacional de Contratistas, hace constar que:</h4>
                    </div>
                    <div class="col-12 text-center mt-3 mb-3">
                        <h3><b>INFORMACIÓN DEL CONTRATISTA</b></h3>
                    </div>
                    <div class="col-2"></div>
                    ...
                    <h4>Se encuentra HABILITADO para contratar con la Administración Pública Nacional, Estadal y Municipal en adquisición de bienes, servicios y ejecución de obras,
                        ...
                        de fecha 19 de noviembre de 2014, para el período:</h4>
                    </div>
                    <div class="col-2"></div>
                    <div class="col-2 text-right">
                        <h4><b>Desde:</b></h4>
                    ...
                    <div class="col-12 mt-3 mb-5 text-justify">
                        <h4>El contratista acepta someterse a lo establecido en el artículo 10 de la Ley Constitucional Contra la Guerra Económica para la Racionalidad y
