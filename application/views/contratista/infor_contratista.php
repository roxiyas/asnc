    ...
    <div class="row">
        ...
        <div class="col-lg-12" style="display: none" id="items">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" id="existe">
                    <div class="row">
                        ...
                        <div class="form-group col-3">
                            ...
                            <input type="text" name="numcontrol_certrnc" id="numcontrol_certrnc" class="form-control"
                                readonly>
                        </div>
                        <div class="form-group col-3">
                ...
                <div class="panel-body" id="no_existe">
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-2 mb-2">
                            <h4 class="mt-2"><label>Rif no Registrado!..</label></h4>
                ...
                <div class="form-group col 12 text-center">
                   Imprimir Planilla Resumen   / Imprimir Certificado / Imprimir Copia Certificada <br>
