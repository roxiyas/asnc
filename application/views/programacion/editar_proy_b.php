...
<div id="content" class="content">
    <div class="row">
    	<div class="col-lg-12">
            <form action="<?=base_url()?>index.php/programacion/editar_programacion_proy_b" method="POST" class="form-horizontal">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-7 mt-4">
                                <button type="button" onclick="agregar_acc_ff(this);" class="btn btn-lg btn-default" id="btn_agregar_b" name="btn_agregar_b">
                                    Agregar
                                </button>
                            </div>
                            <hr style="border-top: 1px solid rgba(0, 0, 0, 0.17);">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="form-group col-12">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <input title="Debe ingresar una palabra para realizar la busqueda" type="text" class="form-control" name="ccnu_b_m_b" id="ccnu_b_m_b" onblur="buscar_ccnnu_m_b();">
                            </div>
                            <div class="col-8">
...
<script src="<?=base_url()?>/js/llenar_editar_proy_b.js"></script>
<script src="<?=base_url()?>/js/agregar_proyecto_edit.js"></script>
<script src="<?=base_url()?>/js/agregar_proyecto_ff.js"></script>
<script src="<?=base_url()?>/js/calculos_bienes_edit.js"></script>
