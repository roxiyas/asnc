                ...
                <div class="panel-body">
                    <form id="reg_bien" method="POST" class="form-horizontal">
						...
						<div class="col-12 text-center mt-3">
							<button class="btn btn-circle waves-effect btn-lg waves-circle waves-float btn-primary" type="button" onclick="guardar_bien();" id="btn_guar_2" name="button" disabled>Guardar</button>
						</div>
                        </div>
                    </form>
                </div>
