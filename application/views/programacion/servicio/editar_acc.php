...
<div id="content" class="content">
    <div class="row">
    	<div class="col-lg-12">
            <form action="<?=base_url()?>index.php/Programacion/editar_programacion_acc" method="POST" class="form-horizontal">
...
<script src="<?=base_url()?>/js/servicio/llenar_editar_acc.js"></script>
