                         ...
                         <div class="panel-body" id="existe">
                             <div class="row">
                                 ...
                                 <div class="form-group col-3">
                                     ...
                                     <input type="text" name="cod_onapre" id="cod_onapre" class="form-control" disabled>
                                 </div>
                                 <div class="form-group col-3">
                                     <label>Siglas</label>
                                     <input type="text" name="siglas" id="siglas" class="form-control" disabled>
                                 </div>
                                 <div class="form-group col-3">
                                     <label>Dirección Fiscal</label>
                                     <input type="text" name="direccion_fiscal" id="direccion_fiscal" class="form-control" disabled>
                                 </div>
                                 <div class="col-6"></div>
                             </div>
                         </div>
                         ...
                         <div class="panel-body">
                             <div class="row">
                                 <div class="form-group col-6">
                                     ...
                                     <input class="form-control" type="text" name="unidad_1" id="unidad_1" disabled>
